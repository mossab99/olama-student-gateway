...
define('OLAMA_STUDENT_GATEWAY_VERSION', '0.4.0');
...
require_once OLAMA_STUDENT_GATEWAY_PATH . 'includes/providers/class-school-context-provider.php';
require_once OLAMA_STUDENT_GATEWAY_PATH . 'includes/providers/class-video-library-provider.php';
